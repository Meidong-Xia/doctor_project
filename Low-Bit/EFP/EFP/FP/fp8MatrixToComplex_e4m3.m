function complexMatrix = fp8MatrixToComplex_e4m3(fp8RealMatrix, fp8ImagMatrix)
    ...
    for i = 1:rows
        for j = 1:cols
            ...
            realPart = fp8Todecimal_e4m3(fp8RealMatrix{i, j});
            imagPart = fp8Todecimal_e4m3(fp8ImagMatrix{i, j});
            % 构建复数

function [result_fp8Binary, result_config] = EFP_add_matrix(fp8Binary1, config1, fp8Binary2, config2, base, fraction_tables,table)
    % % %     生成一个 4x4 复数域矩阵
    ...
    % [result_fp8Binary, result_config] = arrayfun(@i_EFP_add,fp8Binary1,config1,fp8Binary2,config2,'UniformOutput',false);
    ...
    for idx = 1:numElements
        ...
        [result_fp8Binary{idx}, result_config{idx}] = i_EFP_add(fp8Binary1(idx), config1(idx),fp8Binary2(idx),config2(idx), base, fraction_tables,table);
    end

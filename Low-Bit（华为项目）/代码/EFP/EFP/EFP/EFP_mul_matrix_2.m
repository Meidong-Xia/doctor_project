function [result] = EFP_mul_matrix_2(fp81, fp82, m_bit, base, fraction_tables_par,table_par)
    ...
    [result_efp, result_config] = EFP_mul_matrix(matrix_efp1,matrix_config1,matrix_efp2,matrix_config2, ...

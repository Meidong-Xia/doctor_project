function [fp8RealMatrix, fp8ImagMatrix] = complexToFP8Matrix_e4mX(complexMatrix,m)
    ...
    for i = 1:rows
        for j = 1:cols
            ...
            realPartBinary = decimalTofp8_e4mX(real(complexMatrix(i, j)),m);
            imagPartBinary = decimalTofp8_e4mX(imag(complexMatrix(i, j)),m);

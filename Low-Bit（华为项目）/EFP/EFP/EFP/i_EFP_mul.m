function [result_fp8Binary, result_config] = i_EFP_mul(fp8Binary1, config1, fp8Binary2, config2, base, fraction_tables,table)
    % 做复数二进制的拆解工作
    config1 = config1{1};
    config2 = config2{1};
    ...
    [result_real, real_config] = EFP_sub(temp1_real, temp1_real_config, temp2_real, temp2_real_config, base, fraction_tables,table);
    [result_imag, imag_config] = EFP_add(temp1_imag, temp1_imag_config, temp2_imag, temp2_imag_config, base, fraction_tables,table);
